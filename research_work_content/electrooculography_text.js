						...
						<div class="col-lg-8 col-lg-offset-2">\
								<div class="modal-body">\
										...
										<div class="col-lg-12 text-center">\
												<h2>Electrooculography E-Stop System</h2>\
										</div>\
										<img class="img-responsive img-centered" src="img/portfolio/thumbnails/eog_preview.jpg" alt="">\
										<p></p>\
										<p>\
											...
											tracking equipment our project would provide an emergency stop for those who can not physically hit a button but are still in control of heavy machinery.\
											 ...
											 the patient is looking left or right. By measuring the spike in voltage difference, we will implement an emergency stop. To accomplish this we will be required to design\
											 a circuit board with voltage amplifiers and filters along with a USB microcontroller to process the signal. The signals read by the micro controller are routed to a software system\
											 that will calibrate, collect and process signal data from the electrodes.\
										 </p>\
